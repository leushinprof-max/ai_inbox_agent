...
- [Telegram notifications](telegram-notifications.md): personal workspace subscriptions, draft approvals, setup and rollout.
...
- [Hosted development](dev-environment.md): running isolated resources, deployment identities, verification and remaining provider acceptance.
