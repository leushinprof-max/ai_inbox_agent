...
- **Secrets.** Web and worker receive their environment variables from the hosts; values stay out of tracked files and deployment uploads. Preserve the encryption key when redeploying.
